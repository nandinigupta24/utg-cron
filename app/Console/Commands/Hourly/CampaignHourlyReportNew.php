...
class CampaignHourlyReportNew extends Command {
     ...
     * @var string
     */
    protected $signature = 'command:CampaignHourlyReportNew';
    ...
    public function handle() {
        ...
        $data['Main']['CampaignID'] = DB::connection('MainDialer')->table('campaigns')->where('active', 'Y')->pluck('campaign_id')->toArray();
        
        $data['Omni']['HideCampaign'] = [1004];
        $data['Main']['HideCampaign'] = [1404,3027,1308,3008];
...
//      
        ...
        $mail_data['view'] = !empty($data['view']) ? $data['view'] : 'emails.hourly.campaign_report_new';
