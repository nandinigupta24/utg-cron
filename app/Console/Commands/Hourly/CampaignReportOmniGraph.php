...
class CampaignReportOmniGraph extends Command {
     ...
     * @var string
     */
    protected $signature = 'command:CampaignReportOmniGraph';
...
//        $MainDialer = get_graph_values_full_dialer_value('OmniDialer', $start, $end, $HideCampaign);
        $MainDialer = get_hourly_report_campaign_graph($start, $end,'OmniDialer',$HideCampaign);
        ...
        foreach ($MainDialer as $key => $dialer) {
            ...
            $imageSLA = get_image_path_chart('http://export.highcharts.com/' . $result, $key . '-' . $dynamicNumber, '/Hourly/CampaignReport/Omni/');
        }
    }
