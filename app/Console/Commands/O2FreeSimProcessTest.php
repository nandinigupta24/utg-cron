...
class O2FreeSimProcessTest extends Command {
     ...
     * @var string
     */
    protected $signature = 'command:O2FreeSimProcessTest';
...
//        $date = date('Ymd');
        ...
        $FILEname = '/var/www/html/cron/storage/Automation/O2FreeSim/In/2019-11-20-outboundcalling [20191120 142709].csv';
...
//        $dataLoaded = $reader->toArray();
        ...
        while (($getData = fgetcsv($file, 10000, ",")) !== FALSE) {
            $Count++;
            if($Count == 1 || $getData[8] != '07906424343'){
                continue;
            }
            $array = [];
