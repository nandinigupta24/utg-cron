...
class O2FreeSimSFTP1 extends Command {
     ...
     * @var string
     */
    protected $signature = 'command:O2FreeSimSFTP1';
    ...
    public function handle() {
        ...
        if (ssh2_auth_password($connection, $serverUser, $serverPassword)) {
            ...
            $sftp_fd = intval($sftp);
            $files = scandir("ssh2.sftp://" . $sftp_fd . "/home/Ankit/O2OldData/OtherCampaign/FinishedSources/Scottish Power/SP High Prem/", SCANDIR_SORT_DESCENDING);
...
//                if (strpos($value, 'O2FreeSIM') !== false) {
                    ...
                    $content = file_get_contents("ssh2.sftp://" . $sftp_fd . "/home/Ankit/O2OldData/OtherCampaign/FinishedSources/Scottish Power/SP High Prem/" . $value);
...
//                }
        ...
        $arrayPhone = ['phone', 'mobile','mobile_number','phone_number', 'mpn','tel','telephone1','datarecordtelephone', 'telephone', 'telephone_number','phonenumber','telephonenumber','mobilenumber'];
...
//                if ($PhoneColumn == 'telephone') {
                    ...
                    $O2Data->Reference = (!empty($value['datarecordid'])) ? $value['datarecordid'] : '';
                    $O2Data->Title = (!empty($value['datarecordtitle'])) ? $value['datarecordtitle'] : '';
                    $O2Data->Firstname = (!empty($value['datarecordfirstname'])) ? $value['datarecordfirstname'] : '';
                    $O2Data->Surname = (!empty($value['datarecordlastname'])) ? $value['datarecordlastname'] : '';
                    ...
                    $O2Data->source = (!empty($value['DataRecordSupplierSource'])) ? $value['DataRecordSupplierSource'] : '';
                    ...
                    $O2Data->email = (!empty($value['DataRecordEmail'])) ? $value['DataRecordEmail'] : '';
                    $O2Data->gas_provider = (!empty($value['energysupplier'])) ? $value['energysupplier'] : '';
                    $O2Data->electricity_provider = (!empty($value['electricity_provider'])) ? $value['electricity_provider'] : '';
                    $O2Data->broadband_provider = (!empty($value['broadband_provider'])) ? $value['broadband_provider'] : '';
                    $O2Data->age = (!empty($value['age'])) ? $value['age'] : '';
                    $O2Data->gender = (!empty($value['gender'])) ? $value['gender'] : '';
                    $O2Data->SupplierCode = (!empty($value['supplier'])) ? $value['supplier'] : '';
                    $O2Data->LeadType = (!empty($value['leadtype'])) ? $value['leadtype'] : '';
                    $O2Data->ContactLoadID = (!empty($value['contactloaddatekey'])) ? $value['contactloaddatekey'] : '';
                    $O2Data->campaign = 'SPHighPrem';
