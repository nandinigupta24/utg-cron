            ...
            foreach ($talkingPeople as $key => $value) {
                ...
                if ($dataExist == 0) {
                    ...
                    if ($value->security_phrase == 'TC_1') {
                        ...
                        $dataArray['vendor_lead_code'] = 'SEMobile_TC1_OPT_' . str_pad($CountTC1, 8, '0', STR_PAD_LEFT);
                    } elseif ($value->security_phrase == 'TC_2') {
                        $dataArray['source_id'] = 'SEMobile_TC2_OPT';
                        $dataArray['Datasource'] = 'SEMobile_TC2_OPT';
                        $dataArray['vendor_lead_code'] = 'SEMobile_TC2_OPT_' . str_pad($CountTC2, 8, '0', STR_PAD_LEFT);
                    } else {
                        $dataArray['source_id'] = 'SEMobile_RD_OPT';
                        $dataArray['Datasource'] = 'SEMobile_RD_OPT';
                        $dataArray['vendor_lead_code'] = 'SEMobile_RD_OPT_' . str_pad($CountTC2, 8, '0', STR_PAD_LEFT);
                    }
