        ...
        if (!empty($data) && count((array) $data) > 0) {
            foreach ($data as $key => $value) {
                ...
                if (!empty($userData) && count((array) $userData) > 0) {
                    if (in_array($userData->campaign_id, $o2CampaignAgentLog)) {
                        ...
                        if (!empty($dataSale1) && count((array) $dataSale1) > 0) {
                            if (!empty($dataSale1->campaign_id) && in_array($dataSale1->campaign_id, $o2CampaignAgentLog)) {
                                /* Send Mail */
                                $dataAlert = [];
                                ...
                                $arrayMailTo = ['Collin.Alexander@intelling.co.uk', 'Mike.Oxton@intelling.co.uk', 'George.Eastham@switchexperts.co.uk', 'annie.seisay@intelling.co.uk', 'Peter.Dempster@intelling.co.uk', "Aoife.O'Reilly@intelling.co.uk", 'danielle.rossall@intelling.co.uk'];
                            ...
                            if (!empty($dataSale2->campaign_id) && in_array($dataSale2->campaign_id, $o2CampaignAgentLog)) {
                                /* Send Mail */
                                $dataAlert = [];
                                $dataAlert['user'] = $value->user;
                    ...
                    if (in_array($userData->campaign_id, $o2CampaignAgentLog)) {
                        ...
                        if (!empty($dataSale1) && count((array) $dataSale1) > 0) {
                            ...
                            if (!empty($dataSale2->campaign_id) && in_array($dataSale2->campaign_id, $o2CampaignAgentLog)) {
                                ...
                                $mail_data['from'] = !empty($data['from']) ? $data['from'] : 'intellingreports@intelling.co.uk';
                                $mail_data['msg'] = !empty($data['message']) ? $data['message'] : '';
                                $mail_data['view'] = !empty($data['view']) ? $data['view'] : 'emails.talktalk.alert';
                                $mail_data['cc'] = !empty($data['cc']) ? $data['cc'] : $arrayMailCC;
                                $mail_data['subject'] = !empty($data['subject']) ? $data['subject'] : 'Talk Talk Alert';
                                $mail_data['moved_agents'] = @$dataAlert;
                                $result = Mail::send($mail_data['view'], ['data' => $mail_data], function ($m) use ($mail_data) {
