...
class O2FreeSimSFTP2 extends Command {
     ...
     * @var string
     */
    protected $signature = 'command:O2FreeSimSFTP2';
    ...
    public function handle() {
        ...
        if (ssh2_auth_password($connection, $serverUser, $serverPassword)) {
            ...
            $sftp_fd = intval($sftp);
            $files = scandir("ssh2.sftp://" . $sftp_fd . "/home/Ankit/O2OldData/OtherCampaign/FinishedSources/Stratagem/ILD_B2B_20131121_100128/", SCANDIR_SORT_DESCENDING);
...
//                if (strpos($value, 'O2FreeSIM') !== false) {
                    ...
                    $content = file_get_contents("ssh2.sftp://" . $sftp_fd . "/home/Ankit/O2OldData/OtherCampaign/FinishedSources/Stratagem/ILD_B2B_20131121_100128/" . $value);
...
//                if ($PhoneColumn == 'telephone') {
                    ...
                    $O2Data->Reference = (!empty($value['id'])) ? $value['id'] : '';
                    $O2Data->Title = (!empty($value['title'])) ? $value['title'] : '';
                    $O2Data->Firstname = (!empty($value['fname'])) ? $value['fname'] : '';
                    $O2Data->Surname = (!empty($value['sname'])) ? $value['sname'] : '';
                    $O2Data->Address1 = (!empty($value['add1'])) ? $value['add1'] : '';
                    $O2Data->Address2 = (!empty($value['add2'])) ? $value['add2'] : '';
                    $O2Data->address3 = (!empty($value['add3'])) ? $value['add3'] : '';
