    ...
    <table border="0" cellpadding="0" cellspacing="0" class="body" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; background-color: #f6f6f6;">
      <tr>
        ...
        <td class="container" style="font-family: sans-serif; font-size: 14px; vertical-align: top; display: block; Margin: 0 auto; max-width: 700px; padding: 10px; width: 700px;">
          <div class="content" style="box-sizing: border-box; display: block; Margin: 0 auto; max-width: 700px; padding: 10px;">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                    <tr>
                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; box-sizing: border-box;">
                            ...
                            <tbody>
                                ...
                                <tr style="text-align:center;">
                                        <td>{{(!empty($data['number_of_records'])) ? $data['number_of_records'] : 0}}</td>
                                        <td>{{(!empty($data['loaded_records'])) ? $data['loaded_records'] : 0}}</td>
                                        <td>{{(!empty($data['duplicate_on_loaded'])) ? $data['duplicate_on_loaded'] : 0}}</td>
                                        <td>{{(!empty($data['count_of_PACKDESC'])) ? $data['count_of_PACKDESC'] : 0}}</td>
                                        <td>{{(!empty($data['count_of_FILECODE'])) ? $data['count_of_FILECODE'] : 0}}</td>
                                </tr>
                               
                            </tbody>
                        </table>
                        <?php if(!empty($data['PACKDESK']) && count($data['PACKDESK']) > 0){?>
                        <hr/>
                        <h3>Packdesc Count</h3>
                        <table border="0" cellpadding="0" cellspacing="0" class="" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 50%; box-sizing: border-box;">
                            <thead>
                                <tr>
                                    <th>Packdesc</th>
                                    <th>Records</th>
                            ...
                            <tbody>
                                <?php foreach($data['PACKDESK'] as $key=>$val){?>
                                <tr style="text-align:center;">
                                    <th>{{$key}}</th>
                                    <td>{{$val}}</td>
                                </tr>
                        ...
                        <?php if(!empty($data['FILECODE']) && count($data['FILECODE']) > 0){?>
                        <h3>Filecode Count</h3>
                        <hr/>
                        <table border="0" cellpadding="0" cellspacing="0" class="" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 50%; box-sizing: border-box;">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                <?php foreach($data['FILECODE'] as $key=>$val){?>
                                <tr style="text-align:center;">
                                    <th>{{$key}}</th>
                                    <td>{{$val}}</td>
                                </tr>
