<html>
    ...
    <div class="row">
	 <div class="col-lg-12">
         ...
         $FTE1 = $data['data']['FTE1'];
         $SaleTargetGroup = $data['data']['SaleTargetGroup'];
        ?>
                ...
                foreach ($newArray as $key => $value) {
                    ...
                    switch ($key) {
                        case 'Southmoor':
                            ...
                            $StartTime = 11;
                            $EndTime = 19;
                            $SPATarget = $SaleTargetGroup['Southmoor'];
                        ...
                        case 'Belfast':
                            ...
                            $HoursWorked = ($SessionUpdateTime - $StartTime);
                            $HoursRemaining = ($EndTime - $SessionUpdateTime);
                            $SPATarget = (!empty($SaleTargetGroup['Belfast'])) ? $SaleTargetGroup['Belfast'] : 0;
                            $SaleTarget = $FTE * $SPATarget;
                            $SessionTargetSale = (($SaleTarget / 8) * $HoursWorked);
                            $PercentageSessionTarget = (!empty($SessionTargetSale)) ? ceil(($sale / $SessionTargetSale) * 100) : 0;
                            $PercentageDayToTarget = (!empty($SaleTarget)) ? ($sale / $SaleTarget) * 100 : 0;
                        ...
                        case 'Burnley':
                            ...
                            $HoursWorked = ($SessionUpdateTime - $StartTime);
                            $HoursRemaining = ($EndTime - $SessionUpdateTime);
                            $SPATarget = (!empty($SaleTargetGroup['Burnley'])) ? $SaleTargetGroup['Burnley'] : 0;
                            $SaleTarget = $FTE * $SPATarget;
                            $SessionTargetSale = (($SaleTarget / 8) * $HoursWorked);
                            $PercentageSessionTarget = (!empty($SessionTargetSale)) ? ceil(($sale / $SessionTargetSale) * 100) : 0;
                            $PercentageDayToTarget = (!empty($SaleTarget)) ? ($sale / $SaleTarget) * 100 : 0;
                        ...
                        case 'Synergy':
                            ...
                            $HoursWorked = ($SessionUpdateTime - $StartTime);
                            $HoursRemaining = ($EndTime - $SessionUpdateTime);
                            $SPATarget = (!empty($SaleTargetGroup['Synergy'])) ? $SaleTargetGroup['Synergy'] : 0;
                            $SaleTarget = $FTE * $SPATarget;
                            $SessionTargetSale = (($SaleTarget / 8) * $HoursWorked);
                            $PercentageSessionTarget = (!empty($SessionTargetSale)) ? ceil(($sale / $SessionTargetSale) * 100) : 0;
                            $PercentageDayToTarget = (!empty($SaleTarget)) ? ($sale / $SaleTarget) * 100 : 0;
                        ...
                        case 'SLM':
                            ...
                            $HoursWorked = ($SessionUpdateTime - $StartTime);
                            $HoursRemaining = ($EndTime - $SessionUpdateTime);
                            $SPATarget = (!empty($SaleTargetGroup['SLM'])) ? $SaleTargetGroup['SLM'] : 0;
                            $SaleTarget = $FTE * $SPATarget;
                            $SessionTargetSale = (($SaleTarget / 8) * $HoursWorked);
                            $PercentageSessionTarget = (!empty($SessionTargetSale)) ? ceil(($sale / $SessionTargetSale) * 100) : 0;
                            $PercentageDayToTarget = (!empty($SaleTarget)) ? ($sale / $SaleTarget) * 100 : 0;
                        ...
                        case 'Teleperformance':
                            $FTE = (!empty($FTE1['Teleperformance'])) ? $FTE1['Teleperformance'] : 0;
                            $StartTime = 11;
                            $EndTime = 19;
                            $HoursWorked = ($SessionUpdateTime - $StartTime);
                            $HoursRemaining = ($EndTime - $SessionUpdateTime);
                            $SPATarget = (!empty($SaleTargetGroup['TP'])) ? $SaleTargetGroup['TP'] : 0;
                            $SaleTarget = $FTE * $SPATarget;
                            $SessionTargetSale = (($SaleTarget / 8) * $HoursWorked);
                            $PercentageSessionTarget = (!empty($SessionTargetSale)) ? ceil(($sale / $SessionTargetSale) * 100) : 0;
                            $PercentageDayToTarget = (!empty($SaleTarget)) ? ($sale / $SaleTarget) * 100 : 0;
                        ...
                        case 'Outworx':
                            ...
                            $HoursWorked = ($SessionUpdateTime - $StartTime);
                            $HoursRemaining = ($EndTime - $SessionUpdateTime);
                            $SPATarget = (!empty($SaleTargetGroup['Outworx'])) ? $SaleTargetGroup['Outworx'] : 0;
                            $SaleTarget = $FTE * $SPATarget;
                            $SessionTargetSale = (($SaleTarget / 8) * $HoursWorked);
                            $PercentageSessionTarget = (!empty($SessionTargetSale)) ? ceil(($sale / $SessionTargetSale) * 100) : 0;
                            $PercentageDayToTarget = (!empty($SaleTarget)) ? ($sale / $SaleTarget) * 100 : 0;
