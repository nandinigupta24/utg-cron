<html>
    ...
    <body style="color:#fff;">
        ...
        <table class="table table-bordered" style="color:#fff;">
            ...
            <!--START***TTOnlineSMS*********TTOnlineSMS-->
             <tr>
                <th colspan="28" class="text-center" style="color:black">
                    TTOnlineSMS Channel Calls Received / Abandoned
                </th>
            </tr>
            <tr style="background:#136975;">
                <?php 
            ...
            <tr style="background:#136975;">
                <?php
                $campaign = ['offered'=>'TTOnlineSMS','drop'=>'TTOnlineSMS'];
                for ($i = 8; $i <= 21; $i++) {
                    $start = $i;
                    $end = $i+1;
                    $dataOutPut = get_intraday_offered_drop_TALKTALK($date . ' ' . $start . ':00:00', $date . ' ' . $end . ':00:00',$campaign, 15);
            ...
            <!--************END********-->
            <!--START********OnlineSMSov***********OnlineSMSov-->
            <tr>
                <th colspan="28" class="text-center" style="color:black">
                    OnlineSMSov Channel Calls Received / Abandoned
                </th>
            </tr>
            <tr style="background:#136975;">
                <?php 
            ...
            <tr style="background:#136975;">
                <?php
                $campaign = ['offered'=>'OnlineSMSov','drop'=>'OnlineSMSov'];
                for ($i = 8; $i <= 21; $i++) {
                    $start = $i;
                    $end = $i+1;
                    $dataOutPut = get_intraday_offered_drop_TALKTALK($date . ' ' . $start . ':00:00', $date . ' ' . $end . ':00:00',$campaign, 15);
