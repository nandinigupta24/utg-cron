                  ...
                  <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                    <tr>
                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Hi Dear,</p>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" class="" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; box-sizing: border-box;">
                            <tbody>
                                <tr>
                                    <th>File Name - </th>
                                    <td>{{(!empty($data['data']->File_name)) ? $data['data']->File_name.'.dat.gz.gpg' : ''}}</td>
                                </tr>
                                <tr>
                                    <th>MFST File Name - </th>
                                    <td>{{(!empty($data['data']->mfst_file_name)) ? $data['data']->mfst_file_name.'.mfst' : ''}}</td>
                                </tr>
                                <tr>
                                    <th>Records - </th>
                                    <td>{{(!empty($data['data']->records)) ? $data['data']->records : ''}}</td>
                                </tr>
                                <tr>
                                    <th>Failed - </th>
                                    <td>{{(!empty($data['data']->failed)) ? $data['data']->failed : ''}}</td>
                                </tr>
                                <tr>
                                    <th>List Id - </th>
                                    <td>{{(!empty($data['data']->list_id)) ? $data['data']->list_id : ''}}</td>
                                </tr>
                            </tbody>
                        </table>
