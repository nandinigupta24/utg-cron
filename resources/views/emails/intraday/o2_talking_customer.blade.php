                ...
                <th colspan="25" class="text-center">
                    &nbsp;
                            ...
                            <tr style="background:#136975;">
                                <th colspan="25" class="text-center"> TalkingCust</th>
                            </tr>
                            <tr style="background:#136975;">
                            ...
                            <tr style="background:#136975;">
                             ...
                             <tr style="background:#136975;">
                                ...
                                for($i=10;$i<=20;$i++){
                                    $start = $i;
                                    $end = $i+1;
                                   $dataOutPut =  get_talking_customer_offered_drop($date.' '.$start.':00:00',$date.' '.$end.':00:00','TalkingCust',15);
                                ...
                                <td align="center">{{$saleData = get_o2inbound_intraday_sale($date,'TalkingCust')}}</td>
             ...
             <tr>
                <th colspan="25" class="text-center">
                    &nbsp;
                            ...
                            <tr style="background:#136975;">
                                <th colspan="25" class="text-center"> TalkCust2</th>
                            </tr>
                            <tr style="background:#136975;">
                                <th colspan="2" class="text-center">10</th>
                                <th colspan="2" class="text-center">11</th>
                            ...
                            <tr style="background:#136975;">
                             ...
                             <tr style="background:#136975;">
                                ...
                                for($i=10;$i<=20;$i++){
                                    $start = $i;
                                    $end = $i+1;
                                   $dataOutPut =  get_talking_customer_offered_drop($date.' '.$start.':00:00',$date.' '.$end.':00:00','TalkCust2',15);
                                   $totalOffered[] = @$dataOutPut['offered'];
                                   $totalAbondaned[] = @$dataOutPut['drop'];
                                ...
                                <?php }?>
                                <td align="center">{{$totalCalls = (!empty($totalCall) && count($totalCall) > 0) ? array_sum($totalCall) : 0}}</td>
                                <td align="center">{{$saleData = get_o2inbound_intraday_sale($date,'TalkCust2')}}</td>
                                <td align="center">{{(!empty($totalCalls)) ? ceil((($saleData * 100)/$totalCalls)) : 0}}%</td>
                            </tr>
                            <tr>
                                <td colspan="22"></td>
                    ...
                    $imageSLA = get_image_path_chart('http://export.highcharts.com/'.$result,'SLA-'.date('Y-m-d-H-i-s'),'/IntradayReport/TalkingCust/');
                    ...
                    <img src="<?php echo $imageSLA; ?>" download='AHT'/>
                                ...
                                <td colspan="4"> <table class="table table-striped" style="color:#000;">
                                        ...
                                        <tr>
                                            <td class="text-center">{{$totalSale = get_talking_customer_sales($date,NULL)}}</td>
                    ...
                    $context = stream_context_create($options);
                    $result = file_get_contents($url, false, $context);
                    $imageSLA = get_image_path_chart('http://export.highcharts.com/'.$result,'AWHT-'.date('Y-m-d-H-i-s'),'/IntradayReport/TalkingCust/');
                    ...
                    $context = stream_context_create($options);
                    $result = file_get_contents($url, false, $context);
                    $imageSLA = get_image_path_chart('http://export.highcharts.com/'.$result,'ITO-'.date('Y-m-d-H-i-s'),'/IntradayReport/TalkingCust/');
