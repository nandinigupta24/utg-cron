...
//                            $fileName = $value."-".$data['DynamicNumber'].".jpg";
//                            $url = storage_path('PieChart/Hourly/CampaignReport/NewConnex/').$fileName;
//                            if (file_exists($url)){
//                                echo  '<img src="https://api.usethegeeks.com/storage/PieChart/Hourly/CampaignReport/NewConnex/'.$fileName.'"/>';
//                            }
//                        }
                    ?>
