                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href= "{{route('CronEdit',[$val->id])}}"class="btn btn-primary btn-xs" title="Edit"><i class="fa fa-edit"></i></a> 
                                        <a href="{{route('CronView',[$val->id])}}"class="btn btn-success btn-xs" title="View"><i class="fa fa-list"></i></a>
                                        <a href="{{route('CronRemove',[$val->id])}}" onclick="return confirm('Are you sure you want to remove this?')" class="btn btn-danger btn-xs" title="Remove"><i class="fa fa-times"></i></a>
